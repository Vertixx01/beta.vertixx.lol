  ...
  return (
    <div className={'h-screen w-screen bg-[#121212] font-mono'}>
      ...
      <div className={'flex flex-col justify-center items-center mb-64'}>
        <div id='top' className={'flex flex-row gap-2 font-bold h-10 w-32 rounded-3xl bg-[#2B2B3B] justify-center items-center mt-14 cursor-pointer'} onClick={() => window.location.href = 'https://www.youtube.com/watch?v=ULkTyay1hx8'}>
      ...
      <div className={'flex flex-col justify-center items-center drop-shadow-glow'}>
        <h1 className={'text-white text-base sm:text-2xl font-bold'}>Hey, I&apos;m
          <span id='magic-name' className={'underline font-extrabold text-transparent'}> Vertixx</span>
        </h1>
